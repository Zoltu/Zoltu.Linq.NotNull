...
namespace Zoltu.Linq.NotNull
{
	...
	internal sealed class SelectAndSwallowEnumerable<TSource, TResult, TException> : INotNullEnumerable<TResult> where TException : Exception
	{
		...
		public SelectAndSwallowEnumerable(INotNullEnumerable<TSource> source, Func<TSource, TResult> predicate)
		{
